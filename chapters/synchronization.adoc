...
ifdef::VK_HUAWEI_cluster_culling_shader[]
  ** ename:VK_PIPELINE_STAGE_2_CLUSTER_CULLING_SHADER_BIT_HUAWEI
  ...
  * ename:VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT specifies the
    ...
    store operations>>, multisample resolve operations for framebuffer
...
ifdef::VK_VERSION_1_2,VK_KHR_depth_stencil_resolve[]
    ...
    format, and flink:vkCmdClearAttachments.
  ...
  * ename:VK_PIPELINE_STAGE_2_ALL_TRANSFER_BIT is equivalent to specifying
    all of:
  ** ename:VK_PIPELINE_STAGE_2_COPY_BIT
...
ifdef::VK_VERSION_1_3,VK_KHR_synchronization2[]
|ename:VK_PIPELINE_STAGE_NONE                                 | None required
endif::VK_VERSION_1_3,VK_KHR_synchronization2[]
|ename:VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT                    | ename:VK_QUEUE_GRAPHICS_BIT or ename:VK_QUEUE_COMPUTE_BIT
|ename:VK_PIPELINE_STAGE_2_PRE_RASTERIZATION_SHADERS_BIT +
ifdef::VK_NV_mesh_shader,VK_EXT_mesh_shader[]
 {nbsp} {nbsp} {nbsp} ename:VK_PIPELINE_STAGE_TASK_SHADER_BIT_EXT +
 {nbsp} {nbsp} {nbsp} ename:VK_PIPELINE_STAGE_MESH_SHADER_BIT_EXT +
endif::VK_NV_mesh_shader,VK_EXT_mesh_shader[]
 {nbsp} {nbsp} {nbsp} ename:VK_PIPELINE_STAGE_VERTEX_SHADER_BIT +
 {nbsp} {nbsp} {nbsp} ename:VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT +
 {nbsp} {nbsp} {nbsp} ename:VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT +
 {nbsp} {nbsp} {nbsp} ename:VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT
                                                              | ename:VK_QUEUE_GRAPHICS_BIT
|ename:VK_PIPELINE_STAGE_2_VERTEX_INPUT_BIT +
 {nbsp} {nbsp} {nbsp} ename:VK_PIPELINE_STAGE_2_INDEX_INPUT_BIT +
 {nbsp} {nbsp} {nbsp} ename:VK_PIPELINE_STAGE_2_VERTEX_ATTRIBUTE_INPUT_BIT
                                                              | ename:VK_QUEUE_GRAPHICS_BIT
...
|ename:VK_PIPELINE_STAGE_2_ALL_TRANSFER_BIT +
 ...
 {nbsp} {nbsp} {nbsp} ename:VK_PIPELINE_STAGE_2_COPY_BIT +
 {nbsp} {nbsp} {nbsp} ename:VK_PIPELINE_STAGE_2_BLIT_BIT +
 {nbsp} {nbsp} {nbsp} ename:VK_PIPELINE_STAGE_2_RESOLVE_BIT +
 {nbsp} {nbsp} {nbsp} ename:VK_PIPELINE_STAGE_2_CLEAR_BIT +
 {nbsp} {nbsp} {nbsp} ename:VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_COPY_BIT_KHR
...
|ename:VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_COPY_BIT_KHR| ename:VK_QUEUE_COMPUTE_BIT
endif::VK_NV_ray_tracing,VK_KHR_acceleration_structure[]
...
ifdef::VK_HUAWEI_invocation_mask[]
|ename:VK_PIPELINE_STAGE_2_INVOCATION_MASK_BIT_HUAWEI         | ename:VK_QUEUE_GRAPHICS_BIT
endif::VK_HUAWEI_invocation_mask[]
ifdef::VK_KHR_video_decode_queue[]
...
ifdef::VK_NV_ray_tracing,VK_KHR_ray_tracing_pipeline[]
  ...
  ** ename:VK_ACCESS_2_SHADER_SAMPLED_READ_BIT
  ** ename:VK_ACCESS_2_SHADER_STORAGE_READ_BIT
ifdef::VK_KHR_ray_tracing_maintenance1+VK_KHR_ray_tracing_pipeline[]
...
ifdef::VK_KHR_video_decode_queue[]
|ename:VK_ACCESS_2_VIDEO_DECODE_READ_BIT_KHR                  | ename:VK_PIPELINE_STAGE_2_VIDEO_DECODE_BIT_KHR
|ename:VK_ACCESS_2_VIDEO_DECODE_WRITE_BIT_KHR                 | ename:VK_PIPELINE_STAGE_2_VIDEO_DECODE_BIT_KHR
endif::VK_KHR_video_decode_queue[]
ifdef::VK_KHR_video_encode_queue[]
|ename:VK_ACCESS_2_VIDEO_ENCODE_READ_BIT_KHR                  | ename:VK_PIPELINE_STAGE_2_VIDEO_ENCODE_BIT_KHR
|ename:VK_ACCESS_2_VIDEO_ENCODE_WRITE_BIT_KHR                 | ename:VK_PIPELINE_STAGE_2_VIDEO_ENCODE_BIT_KHR
endif::VK_KHR_video_encode_queue[]
|====
--
...
or flink:vkQueueBindSparse additionally include in the first synchronization
...
the synchronization scopes are limited to operations within the same
subpass.
...
ifdef::VK_EXT_present_timing[]
  * If pname:timeDomain is ename:VK_TIME_DOMAIN_SWAPCHAIN_LOCAL_EXT,
    the pname:pNext chain must: include a
    slink:VkSwapchainCalibratedTimestampInfoEXT structure.
...
ifdef::VK_EXT_present_timing[]
  * ename:VK_TIME_DOMAIN_SWAPCHAIN_LOCAL_EXT specifies a time domain unique
...
ifdef::VK_EXT_present_timing[]
[open,refpage='VkSwapchainCalibratedTimestampInfoEXT',desc='Structure specifying the swapchain to calibrate a swapchain-local timestamp query',type='structs']
--
The sname:VkSwapchainCalibratedTimestampInfoEXT structure is defined as:

include::{generated}/api/structs/VkSwapchainCalibratedTimestampInfoEXT.adoc[]

  * pname:sType is the type of this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:swapchain is the swapchain to retrieve the
    ename:VK_TIME_DOMAIN_SWAPCHAIN_LOCAL_EXT timestamp from.

include::{generated}/validity/structs/VkSwapchainCalibratedTimestampInfoEXT.adoc[]
--
endif::VK_EXT_present_timing[]
